...
**How to install R and RStudio** (video from Dan Kerchner, GW Libraries and Academic Innovation):

![](https://vimeo.com/1051226618?fl=pl&fe=vl){width="70%"}

<br>

**How to install R packages** (video from intro 2R):

Follow the video instructions to install the collection of packages associated with the tidyverse.

![](https://vimeo.com/416743698){width="70%"}
...
Before watching the video below and following along, please install that R package tidyverse by running the following code: ``` install.packages("tidyverse")```.
...
```{r age1, exercise = TRUE, exercise.lines = 5, message = FALSE}
